...
class ProductResourceTest {
    ...
    public void _shouldGetTheCorrectProductQuantityData() {
        ...
        t1.addLog(InventoryLogEntity.InventoryLogType.INCOMING, s22Ultra.getId(), 13, 0);
        t1.addLog(InventoryLogEntity.InventoryLogType.INCOMING, galaxyBuds2.getId(), 56, 0);
        t1.persist();
        ...
        t5.addLog(InventoryLogEntity.InventoryLogType.INCOMING, s22Ultra.getId(), 20, 0);
        t5.addLog(InventoryLogEntity.InventoryLogType.INCOMING, galaxyBuds2.getId(), 44, 0);
        t5.persist();
